...
config_binary_cnn_vgg19_header = dict(
    num_classes=1,
    shuffle_buffer=1024,
    batch_size=256,
    image_size=(128, 128),
    ...
    history_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_binary_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.npy",
    model_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_binary_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    csv_path=DEFAULT_MODEL_PATH
    + "/log_{0}_binary_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.csv",
    tensorboard_path=DEFAULT_MODEL_PATH
    + "/tensorboard_{0}_binary_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    loss=keras.losses.BinaryCrossentropy(),
    wandb_project="binary-vgg19",
    activation="sigmoid",
    print_model=False,
...
config_binary_cnn_xception_header = dict(
    num_classes=1,
    shuffle_buffer=1024,
    batch_size=256,
    image_size=(128, 128),
    ...
    + "/binary-flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    history_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_binary_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.npy",
    model_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_binary_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    csv_path=DEFAULT_MODEL_PATH
    + "/log_{0}_binary_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.csv",
    tensorboard_path=DEFAULT_MODEL_PATH
    + "/tensorboard_{0}_binary_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    loss=keras.losses.BinaryCrossentropy(),
    wandb_project="binary-xception",
    activation="sigmoid",
    print_model=False,
...
config_multiclass_cnn_vgg19_header = dict(
    num_classes=19,
    shuffle_buffer=1024,
    batch_size=256,
    image_size=(128, 128),
    ...
    history_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_multiclass_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-ratio.npy",
    model_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_multiclass_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-ratio",
    csv_path=DEFAULT_MODEL_PATH
    + "/log_{0}_multiclass_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-ratio.csv",
    tensorboard_path=DEFAULT_MODEL_PATH
    + "/tensorboard_{0}_multiclass_cnn_vgg19_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    loss=keras.losses.CategoricalCrossentropy(),
    wandb_project="multiclass-vgg19",
    activation="softmax",
    print_model=False,
...
config_multiclass_cnn_xception_header = dict(
    num_classes=19,
    shuffle_buffer=1024,
    batch_size=256,
    image_size=(128, 128),
    ...
    + "/multiclass-flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    history_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_multiclass_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-ratio.npy",
    model_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_multiclass_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-ratio",
    csv_path=DEFAULT_MODEL_PATH
    + "/log_{0}_multiclass_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-ratio.csv",
    tensorboard_path=DEFAULT_MODEL_PATH
    + "/tensorboard_{0}_multiclass_cnn_xception_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    loss=keras.losses.CategoricalCrossentropy(),
    wandb_project="multiclass-xception",
    activation="softmax",
    print_model=False,
...
config_binary_vit_header = dict(
    ...
    + "/binary-flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    history_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_binary_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.npy",
    model_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_binary_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    csv_path=DEFAULT_MODEL_PATH
    + "/log_{0}_binary_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.csv",
    tensorboard_path=DEFAULT_MODEL_PATH
    + "/tensorboard_{0}_binary_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    loss=keras.losses.SparseCategoricalCrossentropy(from_logits=True),
    wandb_project="binary-vit",
    activation="sigmoid",
    print_model=False,
...
config_multiclass_vit_header = dict(
    num_classes=19,
    shuffle_buffer=1024,
    batch_size=256,
    image_size=(128, 128),
    ...
    + "/multiclass-flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    history_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_multiclass_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.npy",
    model_path=DEFAULT_MODEL_PATH
    + "/save_at_{0}_multiclass_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    csv_path=DEFAULT_MODEL_PATH
    + "/log_{0}_multiclass_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio.csv",
    tensorboard_path=DEFAULT_MODEL_PATH
    + "/tensorboard_{0}_multiclass_vit_flow-minp2-dim16-cols8-ALL-HEADER-split-ratio",
    loss=keras.losses.SparseCategoricalCrossentropy(from_logits=True),
    wandb_project="multiclass-vit",
    activation="softmax",
    print_model=False,
