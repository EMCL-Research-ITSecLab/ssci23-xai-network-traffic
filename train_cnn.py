...
if __name__ == "__main__":
    ...
    elif args[0] == "binary_cnn_xception_header":
        current_config = config.config_binary_cnn_xception_header
    elif args[0] == "binary_cnn_vgg19_header":
        current_config = config.config_binary_cnn_vgg19_header
    else:
